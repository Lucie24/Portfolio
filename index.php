...
<body>
  ...
  <header id="header">
    <div class="container">
      ...
      <h2>Bienvenue dans mon <span>portfolio</span> !</h2>
          ...
          <div class="row">
            <div class="col-lg-6">
              <ul>
                ...
                <li><i class="bi bi-chevron-right"></i> <strong>Ville :</strong> <span>Limoges, Haute-Vienne (87)</span></li>
                <li><i class="bi bi-chevron-right"></i> <strong>Github :</strong> <a href="https://github.com/Lucie24/" target="_blank">https://github.com/Lucie24/</a></li>

              </ul>
            </div>
            <div class="col-lg-6">
              <ul>
                <li><i class="bi bi-chevron-right"></i> <strong>Téléphone :</strong> <span>06 33 35 89 35</span></li>
                <li><i class="bi bi-chevron-right"></i> <strong>Diplôme :</strong> <span>DEUST Webmaster</span></li>
                <li><i class="bi bi-chevron-right"></i> <strong>Adresse mail :</strong> <span>luciedumas24430pro@gmail.com</span></li>
              </ul>
            </div>
          </div>
          <p class="textJustify">
    ...
    <div class="skills container">
      ...
      <div class="row skills-content">
        ...
        <div class="col-lg-6">
          ...
          <div class="progress">
            <span class="skill">Le dessin <i class="val">100%</i></span>
          ...
          <div class="progress">
            <span class="skill">Le hacking éthique <i class="val">90%</i></span>
            <div class="progress-bar-wrap">
          ...
          <div class="progress">
            <span class="skill">Les jeux vidéos <i class="val">65%</i></span>
            <div class="progress-bar-wrap">
        ...
        <div class="col-lg-6">
          ...
          <div class="progress">
            <span class="skill">Le Jeu De Rôle <i class="val">80%</i></span>
            <div class="progress-bar-wrap">
          ...
          <div class="progress">
            <span class="skill">Les casse-têtes <i class="val">70%</i></span>
            <div class="progress-bar-wrap">
          ...
          <div class="progress">
            <span class="skill">S'occuper des animaux <i class="val">90%</i></span>
            <div class="progress-bar-wrap">
              <div class="progress-bar" role="progressbar" aria-valuenow="90" aria-valuemin="0" aria-valuemax="100"></div>
            </div>
          </div>
          ...
          <div class="swiper-slide">
            <div class="testimonial-item">
              <p>
                Projet d'école :
                <br><br>
                Création d'un jeu sur une période de 3 semaines dans une langue non étudiée : le javascript.
                <br><br>
          ...
          <div class="swiper-slide">
            <div class="testimonial-item">
              <p>
                Projet d'école :
                <br><br>
                Création d'un site internet avec partie loggée utilisant des formulaires sécurisés faisant un lien avec une base de données.
                <br><br>
                <a href="https://github.com/Lucie24/practibot" target="_blank">https://github.com/Lucie24/practibot</a>
              </p>
              <h3>
                <a href="https://github.com/Lucie24/practibot" target="_blank">Practibot</a>
              </h3>
              <h4>Github</h4>
            </div>
          </div><!-- End testimonial item -->
          ...
          <div class="swiper-slide">
            <div class="testimonial-item">
              <p>
                Projet d'école :
                <br><br>
                Création d'une infrastructure réseau pour une entité fictive.
                <br><br>
                <!--Ces liens ne redirigent pas vers la bonne catégorie tant que c'est sur la même page-->
                <a href="index.php#services" class="docu">Documentation</a>
              </p>
              <h3>
                <a href="index.php#services" class="docu">Projet M2L.org</a>
              </h3>
              <h4>Documentation</h4>
            </div>
          </div><!-- End testimonial item -->
  ...
  <!-- ======= Section Certifications (ancien portfolio) ======= -->
  <section id="certifications" class="portfolio">
    <div class="container">
      ...
      <div class="row">
        <div class="col-lg-12 d-flex justify-content-center">
          <ul id="portfolio-flters">
            ...
            <li data-filter=".filter-network">Réseau</li>
            <li data-filter=".filter-cyber">Cybersécurité</li>
          </ul>
        </div>
      </div>
      ...
      <div class="row portfolio-container">
        ...
        <div class="col-lg-4 col-md-6 portfolio-item filter-web">
          <div class="portfolio-wrap">
            <img src="assets/img/certifications/awc_cloud.png" class="img-fluid" alt="">
        ...
        <div class="col-lg-4 col-md-6 portfolio-item filter-cyber">
          <div class="portfolio-wrap">
            <img src="assets/img/certifications/anssi.png" class="img-fluid" alt="">
            <div class="portfolio-info">
              <h4>SECNUM ACADEMY</h4>
              <p>MOOC de l'ANSSI</p>
              <div class="portfolio-links">
